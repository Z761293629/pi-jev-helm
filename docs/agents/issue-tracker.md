...
- **Child ticket**: a GitHub sub-issue linked to the map. If sub-issues are unavailable, use a task-list entry and add `Part of #<map>` to the child. Apply a `wayfinder:<type>` label.
